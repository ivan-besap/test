...
import com.eVolGreen.eVolGreen.Models.Ocpp.Models.BootNotificationRequest;
...
public class OcppClientApp {
    public static void main(String[] args) {
        try {
            OcppClient client = new OcppClient(new URI("ws://localhost:8080/ocpp"));            client.connectBlocking();
