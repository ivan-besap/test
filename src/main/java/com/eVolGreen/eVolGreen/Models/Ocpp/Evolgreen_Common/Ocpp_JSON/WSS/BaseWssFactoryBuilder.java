...
public class BaseWssFactoryBuilder implements WssFactoryBuilder {
    ...
    public BaseWssFactoryBuilder ciphers(List<String> ciphers) {
        if (ciphers == null || ciphers.isEmpty()) {
            throw new IllegalArgumentException("La lista de cifrados no puede ser nula o vacía.");
        }
    ...
    public BaseWssFactoryBuilder sslContext(SSLContext sslContext) {
        if (sslContext == null) {
            throw new IllegalArgumentException("El contexto SSL no puede ser nulo.");
        }
    ...
    public WebSocketServerFactory build() {
        ...
        if (ciphers == null) {
            ...
            return new CustomSSLWebSocketServerFactory(sslContext, ciphers);
        }
    }
    ...
    public void verify() {
        if (sslContext == null) {
            throw new IllegalStateException("El contexto SSL debe estar configurado antes de construir la fábrica.");
        }
    }
}
